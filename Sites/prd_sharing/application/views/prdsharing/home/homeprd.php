            ...
            <div class="table-list">
                ...
                <div class="row">
                        ...
                        <div class="odd">
                          <p class="col-1" style="width: 10%;float: left; ">999</p>
                          <p class="col-2" style="width: 90%;float: left; ">fgsdgsdgfsdgfgfdsgdgsdggsggsgfsdgs</p>
                        </div>
                        <div class="event">
                          <p class="col-1" style="width: 20%;float: left; ">999</p>
